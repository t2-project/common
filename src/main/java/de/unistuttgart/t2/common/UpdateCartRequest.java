 ...
 * 
 * <p>
 * An update may increase or decrease the number of items in the cart, depending
 * on whether the the values in the difference/content map are positive or
 * negative. A negative number implies a decrease of the units of the given
...
public class UpdateCartRequest {
    ...
    /**
     * Get the number of units of a product with the given id or zero if the product
     * is not in the cart.
     * 
